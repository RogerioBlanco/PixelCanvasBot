...
class I18n(object):
    ...
    _all = {
        'en_GB': {
            ...
            'connection_broke': 'Connection broke :(',
            ...
            '--point_x': 'Target x coordinate for strategies that radiate from a single point, such as radiate and spiral',
            '--point_y': 'Target y coordinate for strategies that radiate from a single point, such as radiate and spiral',
        ...
        'tr_TR': {
            ...
            'connection_broke': 'Connection broke :( [NEEDS TRANSLATION]',
            ...
            '--draw_strategy': 'Optional draw strategy avaiable strategy list [linear, p_linear, randomize, status, sketch] default: randomize',
