...
def parse_args():
    ...
    parser.add_argument('--draw_strategy', required=False, default='randomize', dest='draw_strategy', help='Optional draw strategy default by randomize avaiable strategy list [row_line, randomize] ')
